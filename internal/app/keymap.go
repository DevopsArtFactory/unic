...
var screenKeymaps = map[screen][]keyBinding{
	...
	screenCloudFormationStackDetail: {
		...
		{keys: "r", bar: "r: refresh", help: "Refresh stack details and events",
			when: func(m Model) bool { return m.cloudFormation.driftDetectionID == "" }},
	...
	screenSQSQueueList: {
		...
		{keys: "W", bar: "W: watch", help: "Toggle automatic queue-depth refresh"},
		{keys: "I", bar: "I: interval", help: "Cycle the watch interval (5s/15s/30s)"},
	...
	screenELBTargetGroupList: {
		...
		{keys: "W", bar: "W: watch", help: "Toggle automatic target-health refresh"},
		{keys: "I", bar: "I: interval", help: "Cycle the watch interval (5s/15s/30s)"},
	...
	screenAPIGatewayV2APIList: {
		{keys: "↑/↓, j/k", bar: "↑/↓: navigate", help: "Move between HTTP and WebSocket APIs"},
		{keys: "/", bar: "/: filter", help: "Filter by API name, ID, protocol, endpoint, or region"},
		{keys: "r", bar: "r: refresh", help: "Refresh the API list"},
		{keys: "enter", bar: "enter: detail", help: "Open API stages and route summary"},
		{keys: "q / esc", bar: "esc: back", help: "Go back to the feature list"},
		{bar: "H: home"},
	},
	screenAPIGatewayV2APIDetail: {
		{keys: "↑/↓, j/k", bar: "↑/↓: scroll", help: "Scroll API and stage details"},
		{keys: "pgup/pgdn", bar: "pgup/pgdn: page", help: "Scroll API details by one page"},
		{keys: "enter", bar: "enter: routes", help: "Browse routes and integrations"},
		{keys: "r", bar: "r: refresh", help: "Refresh stages, routes, and integrations"},
		{keys: "q / esc", bar: "esc: APIs", help: "Go back to the API list"},
		{bar: "H: home"},
	},
	screenAPIGatewayV2RouteList: {
		{keys: "↑/↓, j/k", bar: "↑/↓: navigate", help: "Move between routes"},
		{keys: "/", bar: "/: filter", help: "Filter by route, authorization, target, or integration"},
		{keys: "r", bar: "r: refresh", help: "Refresh routes and integrations"},
		{keys: "enter", bar: "enter: detail", help: "Open route and integration details"},
		{keys: "q", bar: "q: feature list", help: "Go back to the feature list"},
		{keys: "esc", bar: "esc: API", help: "Go back to API detail"},
		{bar: "H: home"},
	},
	screenAPIGatewayV2RouteDetail: {
		{keys: "↑/↓, j/k", bar: "↑/↓: scroll", help: "Scroll route and integration details"},
		{keys: "pgup/pgdn", bar: "pgup/pgdn: page", help: "Scroll route detail by one page"},
		{keys: "y", bar: "y: copy target", help: "Copy the integration URI or route target",
			when: func(m Model) bool { return m.apiGatewayV2.integrationTarget() != "" }},
		{keys: "g", bar: "g: Lambda", help: "Open the linked function in the Lambda browser",
			when: func(m Model) bool {
				return m.apiGatewayV2.selectedRoute != nil && m.apiGatewayV2.selectedRoute.Integration != nil && m.apiGatewayV2.selectedRoute.Integration.LambdaFunction != ""
			}},
		{keys: "r", bar: "r: refresh", help: "Refresh route and integration details"},
		{keys: "q", bar: "q: feature list", help: "Go back to the feature list"},
		{keys: "esc", bar: "esc: routes", help: "Go back to the route list"},
		{bar: "H: home"},
	},
	screenDynamoDBTableList: {
		{keys: "↑/↓, j/k", bar: "↑/↓: navigate", help: "Move between DynamoDB tables"},
		{keys: "/", bar: "/: filter", help: "Filter by table name, status, or billing mode"},
		{keys: "r", bar: "r: refresh", help: "Refresh the table list"},
		{keys: "enter", bar: "enter: detail", help: "Open the selected table"},
		{keys: "q / esc", bar: "esc: back", help: "Go back to the feature list"},
		{bar: "H: home"},
	},
	screenDynamoDBTableDetail: {
		{keys: "↑/↓, j/k", bar: "↑/↓: scroll", help: "Scroll table and index details"},
		{keys: "pgup/pgdn", bar: "pgup/pgdn: page", help: "Scroll details by one page"},
		{keys: "l", bar: "l: lookup item", help: "Look up one item by its complete primary key"},
		{keys: "r", bar: "r: refresh", help: "Refresh table and TTL metadata"},
		{keys: "q / esc", bar: "esc: back", help: "Go back to the table list"},
		{bar: "H: home"},
	},
	screenDynamoDBLookupInput: {
		{keys: "type", help: "Enter the current primary-key value"},
		{keys: "backspace", help: "Delete the previous character"},
		{keys: "enter", bar: "enter: next / lookup", help: "Advance to the sort key or run GetItem"},
		{keys: "esc", bar: "esc: cancel", help: "Cancel and return to table detail"},
	},
	screenDynamoDBLookupResult: {
		{keys: "↑/↓, j/k", bar: "↑/↓: scroll", help: "Scroll the item JSON"},

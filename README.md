...
| Bedrock API Keys | `c` create, choose current IAM user or another user, `r` rotate secret, `d` delete, type the IAM user/key ID to confirm, `c` copy one-time key, `e` copy `AWS_BEARER_TOKEN_BEDROCK` export |
